...
function Navbar() {
  ...
  <div className="font-serif">
    <div className="w-3/5 xl:text-lg lg:text-base md:text-sm md:flex bg-gray-200 mx-auto justify-between items-center
    ...
    <div className="h-24 mx-auto flex justify-around items-center   sm:text-lg text-sm border-b border-gray-400 md:hidden">
      <div className="flex">
