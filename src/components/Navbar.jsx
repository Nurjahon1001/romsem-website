...
function Navbar() {
  ...
  <div className="font-serif">
    <div className=" 2xl:text-lg lg:text-sm md:flex bg-gray mx-auto justify-between items-center
      ...
      <div className="flex gap-x-96 items-center ">
        <div className="flex lg:justify-between lg:gap-x-8 md:gap-4 items-center">
          <div className="flex flex-col  gap-x-2.5">
            <Link className="hover:text-orange-600" to="/review">Отзывы</Link>
            <Link className="hover:text-orange-600" to="/order">Доставка и оплата</Link>
          </div>
          <div>
            <img src={Group} alt="" />
          </div>
