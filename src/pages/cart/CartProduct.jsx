...
function CartProduct({ item }) {
   ...
   return (
      <div key={item.id} className="sm:text-center w-full flex sm:flex-col sm:gap-0 gap-4 items-center border-b-2">
         ...
         <div className='mx-auto'>
            ...
            <p className='sm:block hidden  text-white font-bold mx-auto w-7 h-7 rounded-full bg-orange-500 mt-1'>{item.quantity}</p>
